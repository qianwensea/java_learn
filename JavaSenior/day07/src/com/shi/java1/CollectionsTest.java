...
//        Collections.copy(list1,list);  报异常:IndexOutOfBoundsException: Source does not fit in dest
        //正确写法
    ...
    public void test1(){
         ...
         */
        List list1 = Collections.synchronizedList(list);//返回的list1就是线程安全的List
    }
}
